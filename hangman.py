...
wordbank = [ 'smith', 'dog', 'yes', 'okay', 'sunday', 'we', 'cat', 'impacc', 'remote', 'wrong', 'short', 'video', 'super', 'idol', 'wall', 'school', 'curriculum', 'circumstance', 'english', 'why', 'suspicious', 'fudgel', 'code', 'git']
